...
A read for anyone who has never coding with MVC before or those wanting to brush up on previous MVC development skills.

##Read:
[MVC for Noobs](https://code.tutsplus.com/tutorials/mvc-for-noobs--net-10488) [The MVC Pattern and PHP, Part 1](https://www.sitepoint.com/the-mvc-pattern-and-php-1/)
...
###The full MVC [request cycle](https://en.wikipedia.org/wiki/Request%E2%80%93response) in a Laravel 5 [application](https://selftaughtcoders.com/model-view-controller-mvc-web-application/)

FOTo

1. A request is made — say, when a user enters a URL associated with your application
...
More information: [Creating a Basic Laravel 5 MVC Application in 10 Minutes](https://selftaughtcoders.com/from-idea-to-launch/lesson-17/laravel-5-mvc-application-in-10-minutes/)
